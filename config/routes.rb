Rails.application.routes.draw do
  ...
  resources :students, only: [ :index, :new, :create, :show, :edit, :update ] do
    ...
    resource :periodization_clone, only: :create, module: :students
  end
  ...
  resources :periodization_versions, only: [ :show, :destroy ] do
    ...
    resource :template, only: :create, module: :periodization_versions
  ...
  resources :training_sessions, only: [ :index, :create, :destroy ] do
    ...
    resource  :workout,           only: :update,               module: :training_sessions
