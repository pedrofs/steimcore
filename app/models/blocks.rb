# Pure-Ruby schema validator for the JSONB +blocks+ column shared by Workout and
# PeriodizationTemplate::Workout. Walks the tree and returns an array of pt-BR
# error strings. Accepts both string- and symbol-keyed hashes (the column hands
# back string keys, but in-process patches come through with symbol keys before
# save). Lives at the top level — it is no longer workout-specific (ADR-0008).
#
