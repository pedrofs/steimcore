...
class BlocksTest < ActiveSupport::TestCase
  ...
  test "empty array is valid" do
    assert_equal [], Blocks.errors_for([])
  end
  ...
  test "exercise block with required fields is valid" do
    ...
    assert_equal [], Blocks.errors_for(blocks)
  end
  ...
  test "block missing kind is rejected" do
    errors = Blocks.errors_for([ { "name" => "x" } ])
  ...
  test "freeform block missing text_md is rejected" do
    errors = Blocks.errors_for([ { "kind" => "freeform" } ])
